...
# build/cp314td/ contains the trace files generated by Cython to be compatible
# with cygdb
...
them and add locking or other forms of synchronization to prevent the races from
occurring.
